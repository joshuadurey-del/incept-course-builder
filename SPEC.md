...
| | |
|---|---|
| **Version** | 2026-09-15.20 (package); contract 2026-09-15.1 |
...
| Author seat | a local server with no model is refused; Claude small and Codex are offered on the screen | the owner picks a seat or loads a local model; 192 pieces wait on it |
